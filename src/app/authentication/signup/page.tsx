...
export default async function SignupPage(props: {
  ...
  return (
    <BeamsBackground intensity="subtle">
      {/* Navigation bar with Home link and Skip button */}
      <div className="absolute top-0 left-0 w-full p-4 md:p-6 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          {/* Skip Button */}
          <Link href="/platform/dashboard" className="backdrop-blur-xl bg-white/10 hover:bg-white/20 border border-white/20 rounded-full px-6 py-2 text-sm text-white/80 hover:text-white transition-all duration-300">
            Skip to Dashboard →
          </Link>
        </div>
      </div>
          ...
          <div className="w-full h-full flex flex-col lg:flex-row lg:items-stretch overflow-hidden rounded-xl bg-black/30 border border-white/10 shadow-2xl">
            ...
            >
              ...
              >
                ...
                {/* Sign Up Form */}
                <div className="bg-black/40 backdrop-blur-sm border border-white/10 shadow-xl rounded-xl relative z-10 p-6">
                  ...
                  <form action={signup} className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        type="email"
                        required
                        className="bg-black/30 border-white/10 text-white placeholder:text-white/40 focus:border-blue-500/50 focus:ring-blue-500/30 transition-all"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        minLength={6}
                      />
                      <p className="text-white/40 text-xs mt-1">Password must be at least 6 characters</p>
                    </div>
                    
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-500 to-violet-500 hover:from-blue-600 hover:to-violet-600 text-white shadow-lg border-0 transition-all duration-300"
                    >
                      Sign Up
                    </Button>
                  </form>
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-white/60 text-sm">
                      ...
                      <Link href="/authentication/login" className="text-blue-400 hover:text-blue-300 transition-colors">
                        Sign in
                      </Link>
                    </p>
                  </div>
              ...
              >
                ...
                <span className="block mt-1 text-white/50 text-xs">
                  Join leading enterprises leveraging autonomous AI agents
                </span>
              </div>
            </div>
