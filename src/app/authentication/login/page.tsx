            ...
            >
              ...
              >
                ...
                <div className="bg-black/40 backdrop-blur-sm border border-white/10 shadow-xl rounded-xl relative z-10 p-6">
                  <h2 className="text-white text-xl font-medium mb-6">Sign in to your account</h2>
                  
                  {searchParams?.message && (
                    <div className="mb-4 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                      <p className="text-green-400 text-sm">{searchParams.message}</p>
                    </div>
                  )}
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-white/60 text-sm">
                      ...
                      <Link href="/authentication/signup" className="text-blue-400 hover:text-blue-300 transition-colors">
                        Sign up
                      </Link>
                    </p>
                  </div>
